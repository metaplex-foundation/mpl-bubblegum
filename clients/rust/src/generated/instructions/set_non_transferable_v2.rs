...
impl SetNonTransferableV2 {
    pub fn instruction(
        &self,
        args: SetNonTransferableV2InstructionArgs,
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let mut data = borsh::to_vec(&(SetNonTransferableV2InstructionData::new())).unwrap();
...
pub struct SetNonTransferableV2InstructionData {
    discriminator: [u8; 8],
}

impl SetNonTransferableV2InstructionData {
    pub fn new() -> Self {
        Self {
...
pub struct SetNonTransferableV2InstructionArgs {
    pub root: [u8; 32],
    pub data_hash: [u8; 32],
...
/// Instruction builder for `SetNonTransferableV2`.
///
/// ### Accounts:
///
...
#[derive(Default)]
pub struct SetNonTransferableV2Builder {
...
impl SetNonTransferableV2Builder {
    pub fn new() -> Self {
        Self::default()
    }
    #[inline(always)]
    ...
    pub fn instruction(&self) -> solana_program::instruction::Instruction {
        let accounts = SetNonTransferableV2 {
        ...
        let args = SetNonTransferableV2InstructionArgs {
...
/// `set_non_transferable_v2` CPI accounts.
pub struct SetNonTransferableV2CpiAccounts<'a, 'b> {
...
/// `set_non_transferable_v2` CPI instruction.
pub struct SetNonTransferableV2Cpi<'a, 'b> {
    ...
    pub __args: SetNonTransferableV2InstructionArgs,
}

impl<'a, 'b> SetNonTransferableV2Cpi<'a, 'b> {
    pub fn new(
        program: &'b solana_program::account_info::AccountInfo<'a>,
        accounts: SetNonTransferableV2CpiAccounts<'a, 'b>,
        args: SetNonTransferableV2InstructionArgs,
    ) -> Self {
        Self {
            __program: program,
...
/// Instruction builder for `SetNonTransferableV2` via CPI.
///
/// ### Accounts:
///
///   0. `[writable]` tree_config
...
///   9. `[]` system_program
pub struct SetNonTransferableV2CpiBuilder<'a, 'b> {
    instruction: Box<SetNonTransferableV2CpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> SetNonTransferableV2CpiBuilder<'a, 'b> {
    pub fn new(program: &'b solana_program::account_info::AccountInfo<'a>) -> Self {
        let instruction = Box::new(SetNonTransferableV2CpiBuilderInstruction {
            __program: program,
            tree_config: None,
            payer: None,
            authority: None,
    ...
    pub fn invoke_signed(
        ...
        let instruction = SetNonTransferableV2Cpi {
...
struct SetNonTransferableV2CpiBuilderInstruction<'a, 'b> {
