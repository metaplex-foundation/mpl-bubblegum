...
impl CreateTreeConfigV2 {
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let mut data = borsh::to_vec(&(CreateTreeConfigV2InstructionData::new())).unwrap();
...
pub struct CreateTreeConfigV2InstructionData {
    discriminator: [u8; 8],
}
...
/// Instruction builder for `CreateTreeConfigV2`.
///
/// ### Accounts:
///
...
///   3. `[signer, optional]` tree_creator
...
/// Instruction builder for `CreateTreeConfigV2` via CPI.
///
/// ### Accounts:
///
///   0. `[writable]` tree_config
