...
impl ThawV2 {
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let mut data = borsh::to_vec(&(ThawV2InstructionData::new())).unwrap();
...
pub struct ThawV2InstructionData {
    discriminator: [u8; 8],
}

impl ThawV2InstructionData {
    pub fn new() -> Self {
        Self {
...
pub struct ThawV2InstructionArgs {
    pub root: [u8; 32],
    pub data_hash: [u8; 32],
...
/// Instruction builder for `ThawV2`.
///
/// ### Accounts:
///
...
/// `thaw_v2` CPI accounts.
pub struct ThawV2CpiAccounts<'a, 'b> {
...
/// `thaw_v2` CPI instruction.
pub struct ThawV2Cpi<'a, 'b> {
    ...
    pub __args: ThawV2InstructionArgs,
}

impl<'a, 'b> ThawV2Cpi<'a, 'b> {
    pub fn new(
        program: &'b solana_program::account_info::AccountInfo<'a>,
        accounts: ThawV2CpiAccounts<'a, 'b>,
        args: ThawV2InstructionArgs,
    ) -> Self {
        Self {
            __program: program,
...
/// Instruction builder for `ThawV2` via CPI.
///
/// ### Accounts:
///
///   0. `[writable]` tree_config
...
///   9. `[]` system_program
pub struct ThawV2CpiBuilder<'a, 'b> {
    instruction: Box<ThawV2CpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> ThawV2CpiBuilder<'a, 'b> {
    pub fn new(program: &'b solana_program::account_info::AccountInfo<'a>) -> Self {
        let instruction = Box::new(ThawV2CpiBuilderInstruction {
            __program: program,
            tree_config: None,
            payer: None,
            authority: None,
...
struct ThawV2CpiBuilderInstruction<'a, 'b> {
