...
pub struct DelegateAndFreezeV2 {
    ...
    pub leaf_owner: Option<solana_program::pubkey::Pubkey>,
    /// Defaults to `leaf_owner`
    pub previous_leaf_delegate: Option<solana_program::pubkey::Pubkey>,
...
impl DelegateAndFreezeV2 {
    pub fn instruction(
        &self,
        args: DelegateAndFreezeV2InstructionArgs,
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        if let Some(previous_leaf_delegate) = self.previous_leaf_delegate {
            accounts.push(solana_program::instruction::AccountMeta::new_readonly(
        ...
        let mut data = borsh::to_vec(&(DelegateAndFreezeV2InstructionData::new())).unwrap();
...
pub struct DelegateAndFreezeV2InstructionData {
    discriminator: [u8; 8],
}

impl DelegateAndFreezeV2InstructionData {
    pub fn new() -> Self {
        Self {
...
pub struct DelegateAndFreezeV2InstructionArgs {
    pub root: [u8; 32],
    pub data_hash: [u8; 32],
...
impl DelegateAndFreezeV2Builder {
    pub fn new() -> Self {
        Self::default()
    }
    #[inline(always)]
    ...
    /// Optional leaf owner, defaults to `payer`
    #[inline(always)]
    pub fn leaf_owner(&mut self, leaf_owner: Option<solana_program::pubkey::Pubkey>) -> &mut Self {
        self.leaf_owner = leaf_owner;
        self
    }
    /// `[optional account]`
    /// Defaults to `leaf_owner`
    ...
    pub fn previous_leaf_delegate(
        ...
        self.previous_leaf_delegate = previous_leaf_delegate;
        self
    }
    #[inline(always)]
    ...
    /// `[optional argument]`
    #[inline(always)]
    pub fn collection_hash(&mut self, collection_hash: [u8; 32]) -> &mut Self {
        self.collection_hash = Some(collection_hash);
        self
    }
    /// `[optional argument]`
    #[inline(always)]
    ...
    pub fn instruction(&self) -> solana_program::instruction::Instruction {
        let accounts = DelegateAndFreezeV2 {
            tree_config: self.tree_config.expect("tree_config is not set"),
            payer: self.payer.expect("payer is not set"),
            leaf_owner: self.leaf_owner,
            previous_leaf_delegate: self.previous_leaf_delegate,
        ...
        let args = DelegateAndFreezeV2InstructionArgs {
...
/// `delegate_and_freeze_v2` CPI accounts.
pub struct DelegateAndFreezeV2CpiAccounts<'a, 'b> {
    pub tree_config: &'b solana_program::account_info::AccountInfo<'a>,

    pub payer: &'b solana_program::account_info::AccountInfo<'a>,
    /// Optional leaf owner, defaults to `payer`
    pub leaf_owner: Option<&'b solana_program::account_info::AccountInfo<'a>>,
    /// Defaults to `leaf_owner`
    pub previous_leaf_delegate: Option<&'b solana_program::account_info::AccountInfo<'a>>,
...
/// `delegate_and_freeze_v2` CPI instruction.
pub struct DelegateAndFreezeV2Cpi<'a, 'b> {
    ...
    pub __args: DelegateAndFreezeV2InstructionArgs,
}

impl<'a, 'b> DelegateAndFreezeV2Cpi<'a, 'b> {
    pub fn new(
        program: &'b solana_program::account_info::AccountInfo<'a>,
        accounts: DelegateAndFreezeV2CpiAccounts<'a, 'b>,
        args: DelegateAndFreezeV2InstructionArgs,
    ) -> Self {
        Self {
            __program: program,
    ...
    pub fn invoke_signed_with_remaining_accounts(
        ...
        if let Some(leaf_owner) = self.leaf_owner {
            account_infos.push(leaf_owner.clone());
        }
        if let Some(previous_leaf_delegate) = self.previous_leaf_delegate {
            account_infos.push(previous_leaf_delegate.clone());
        }
...
impl<'a, 'b> DelegateAndFreezeV2CpiBuilder<'a, 'b> {
    pub fn new(program: &'b solana_program::account_info::AccountInfo<'a>) -> Self {
        let instruction = Box::new(DelegateAndFreezeV2CpiBuilderInstruction {
            __program: program,
            tree_config: None,
            payer: None,
            leaf_owner: None,
    ...
    pub fn leaf_owner(
        ...
        self.instruction.leaf_owner = leaf_owner;
        self
    }
    /// `[optional account]`
    /// Defaults to `leaf_owner`
    ...
    pub fn previous_leaf_delegate(
        ...
        self.instruction.previous_leaf_delegate = previous_leaf_delegate;
        self
    }
    #[inline(always)]
    pub fn new_leaf_delegate(
    ...
    #[inline(always)]
    pub fn collection_hash(&mut self, collection_hash: [u8; 32]) -> &mut Self {
        self.instruction.collection_hash = Some(collection_hash);
        self
    }
    /// `[optional argument]`
    #[inline(always)]
    ...
    pub fn invoke_signed(
        ...
        let args = DelegateAndFreezeV2InstructionArgs {
            ...
            collection_hash: self.instruction.collection_hash.clone(),
        ...
        let instruction = DelegateAndFreezeV2Cpi {
            ...
            leaf_owner: self.instruction.leaf_owner,

            previous_leaf_delegate: self.instruction.previous_leaf_delegate,
...
struct DelegateAndFreezeV2CpiBuilderInstruction<'a, 'b> {
