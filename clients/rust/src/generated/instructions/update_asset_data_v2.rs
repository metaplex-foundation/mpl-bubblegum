...
impl UpdateAssetDataV2 {
    pub fn instruction(
        &self,
        args: UpdateAssetDataV2InstructionArgs,
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let mut data = borsh::to_vec(&(UpdateAssetDataV2InstructionData::new())).unwrap();
...
pub struct UpdateAssetDataV2InstructionData {
    discriminator: [u8; 8],
}

impl UpdateAssetDataV2InstructionData {
    pub fn new() -> Self {
        Self {
...
pub struct UpdateAssetDataV2InstructionArgs {
    pub root: [u8; 32],
    pub data_hash: [u8; 32],
...
impl UpdateAssetDataV2Builder {
    ...
    /// `[optional argument]`
    #[inline(always)]
    pub fn previous_asset_data_hash(&mut self, previous_asset_data_hash: [u8; 32]) -> &mut Self {
        self.previous_asset_data_hash = Some(previous_asset_data_hash);
        self
    }
    /// `[optional argument]`
    #[inline(always)]
    ...
    /// `[optional argument]`
    #[inline(always)]
    pub fn new_asset_data(&mut self, new_asset_data: Vec<u8>) -> &mut Self {
        self.new_asset_data = Some(new_asset_data);
        self
    }
    /// `[optional argument]`
    #[inline(always)]
    pub fn new_asset_data_schema(&mut self, new_asset_data_schema: AssetDataSchema) -> &mut Self {
        self.new_asset_data_schema = Some(new_asset_data_schema);
        self
    }
    ...
    pub fn instruction(&self) -> solana_program::instruction::Instruction {
        let accounts = UpdateAssetDataV2 {
        ...
        let args = UpdateAssetDataV2InstructionArgs {
            ...
            previous_asset_data_hash: self.previous_asset_data_hash.clone(),
            flags: self.flags.clone(),
            nonce: self.nonce.clone().expect("nonce is not set"),
            index: self.index.clone().expect("index is not set"),
            new_asset_data: self.new_asset_data.clone(),
            new_asset_data_schema: self.new_asset_data_schema.clone(),
        };
...
/// `update_asset_data_v2` CPI accounts.
pub struct UpdateAssetDataV2CpiAccounts<'a, 'b> {
...
/// `update_asset_data_v2` CPI instruction.
pub struct UpdateAssetDataV2Cpi<'a, 'b> {
    ...
    pub __args: UpdateAssetDataV2InstructionArgs,
}

impl<'a, 'b> UpdateAssetDataV2Cpi<'a, 'b> {
    pub fn new(
        program: &'b solana_program::account_info::AccountInfo<'a>,
        accounts: UpdateAssetDataV2CpiAccounts<'a, 'b>,
        args: UpdateAssetDataV2InstructionArgs,
    ) -> Self {
        Self {
            __program: program,
...
impl<'a, 'b> UpdateAssetDataV2CpiBuilder<'a, 'b> {
    pub fn new(program: &'b solana_program::account_info::AccountInfo<'a>) -> Self {
        let instruction = Box::new(UpdateAssetDataV2CpiBuilderInstruction {
            __program: program,
            tree_config: None,
            payer: None,
            authority: None,
            ...
            data_hash: None,
            creator_hash: None,
            previous_asset_data_hash: None,
            flags: None,
            nonce: None,
            index: None,
            new_asset_data: None,
            new_asset_data_schema: None,
    ...
    #[inline(always)]
    pub fn previous_asset_data_hash(&mut self, previous_asset_data_hash: [u8; 32]) -> &mut Self {
        self.instruction.previous_asset_data_hash = Some(previous_asset_data_hash);
        self
    }
    /// `[optional argument]`
    #[inline(always)]
    ...
    #[inline(always)]
    pub fn new_asset_data(&mut self, new_asset_data: Vec<u8>) -> &mut Self {
        self.instruction.new_asset_data = Some(new_asset_data);
        self
    }
    /// `[optional argument]`
    #[inline(always)]
    pub fn new_asset_data_schema(&mut self, new_asset_data_schema: AssetDataSchema) -> &mut Self {
        self.instruction.new_asset_data_schema = Some(new_asset_data_schema);
        self
    }
    ...
    pub fn invoke_signed(
        ...
        let args = UpdateAssetDataV2InstructionArgs {
            ...
            previous_asset_data_hash: self.instruction.previous_asset_data_hash.clone(),
            ...
            new_asset_data: self.instruction.new_asset_data.clone(),
            new_asset_data_schema: self.instruction.new_asset_data_schema.clone(),
        };
        let instruction = UpdateAssetDataV2Cpi {
...
struct UpdateAssetDataV2CpiBuilderInstruction<'a, 'b> {
