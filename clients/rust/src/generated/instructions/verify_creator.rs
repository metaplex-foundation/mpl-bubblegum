...
pub struct VerifyCreatorCpiBuilder<'a> {
    instruction: Box<VerifyCreatorCpiBuilderInstruction<'a>>,
}

impl<'a> VerifyCreatorCpiBuilder<'a> {
...
struct VerifyCreatorCpiBuilderInstruction<'a> {
