...
impl FreezeV2 {
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let mut data = borsh::to_vec(&(FreezeV2InstructionData::new())).unwrap();
...
pub struct FreezeV2InstructionData {
    discriminator: [u8; 8],
}

impl FreezeV2InstructionData {
    pub fn new() -> Self {
        Self {
...
pub struct FreezeV2InstructionArgs {
    pub root: [u8; 32],
    pub data_hash: [u8; 32],
...
/// Instruction builder for `FreezeV2`.
///
/// ### Accounts:
///
...
impl FreezeV2Builder {
    ...
    pub fn instruction(&self) -> solana_program::instruction::Instruction {
        ...
        let args = FreezeV2InstructionArgs {
...
/// `freeze_v2` CPI accounts.
pub struct FreezeV2CpiAccounts<'a, 'b> {
...
/// `freeze_v2` CPI instruction.
pub struct FreezeV2Cpi<'a, 'b> {
    ...
    pub __args: FreezeV2InstructionArgs,
}

impl<'a, 'b> FreezeV2Cpi<'a, 'b> {
    pub fn new(
        program: &'b solana_program::account_info::AccountInfo<'a>,
        accounts: FreezeV2CpiAccounts<'a, 'b>,
        args: FreezeV2InstructionArgs,
    ) -> Self {
        Self {
            __program: program,
...
/// Instruction builder for `FreezeV2` via CPI.
///
/// ### Accounts:
///
///   0. `[writable]` tree_config
...
///   9. `[]` system_program
pub struct FreezeV2CpiBuilder<'a, 'b> {
    instruction: Box<FreezeV2CpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> FreezeV2CpiBuilder<'a, 'b> {
    pub fn new(program: &'b solana_program::account_info::AccountInfo<'a>) -> Self {
        let instruction = Box::new(FreezeV2CpiBuilderInstruction {
            __program: program,
            tree_config: None,
            payer: None,
            authority: None,
...
struct FreezeV2CpiBuilderInstruction<'a, 'b> {
