...
impl UpdateMetadataV2 {
    pub fn instruction(
        &self,
        args: UpdateMetadataV2InstructionArgs,
...
pub struct UpdateMetadataV2Builder {
    ...
    nonce: Option<u64>,
    index: Option<u32>,
    current_metadata: Option<MetadataArgsV2>,
    update_args: Option<UpdateArgs>,
    __remaining_accounts: Vec<solana_program::instruction::AccountMeta>,
}

impl UpdateMetadataV2Builder {
    pub fn new() -> Self {
        Self::default()
    }
    #[inline(always)]
    ...
    #[inline(always)]
    pub fn current_metadata(&mut self, current_metadata: MetadataArgsV2) -> &mut Self {
    ...
    pub fn instruction(&self) -> solana_program::instruction::Instruction {
        ...
        let args = UpdateMetadataV2InstructionArgs {
...
/// `update_metadata_v2` CPI instruction.
pub struct UpdateMetadataV2Cpi<'a, 'b> {
    ...
    pub __args: UpdateMetadataV2InstructionArgs,
}

impl<'a, 'b> UpdateMetadataV2Cpi<'a, 'b> {
    pub fn new(
        program: &'b solana_program::account_info::AccountInfo<'a>,
        accounts: UpdateMetadataV2CpiAccounts<'a, 'b>,
        args: UpdateMetadataV2InstructionArgs,
    ) -> Self {
        Self {
            __program: program,
...
impl<'a, 'b> UpdateMetadataV2CpiBuilder<'a, 'b> {
    pub fn new(program: &'b solana_program::account_info::AccountInfo<'a>) -> Self {
        let instruction = Box::new(UpdateMetadataV2CpiBuilderInstruction {
            __program: program,
            tree_config: None,
            payer: None,
            authority: None,
    ...
    pub fn invoke_signed(
        ...
        let instruction = UpdateMetadataV2Cpi {
...
struct UpdateMetadataV2CpiBuilderInstruction<'a, 'b> {
