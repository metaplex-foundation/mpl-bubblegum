...
impl UpdateMetadataCollectionNft {
    pub fn instruction(
        &self,
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let mut data = UpdateMetadataCollectionNftInstructionData::new()
            .try_to_vec()
            .unwrap();
...
impl UpdateMetadataCollectionNftInstructionData {
    fn new() -> Self {
        Self {
...
pub struct UpdateMetadataCollectionNftInstructionArgs {
    pub root: [u8; 32],
    pub nonce: u64,
    pub index: u32,
...
impl UpdateMetadataCollectionNftBuilder {
    pub fn new() -> Self {
        Self::default()
    }
    #[inline(always)]
    ...
    pub fn instruction(&self) -> solana_program::instruction::Instruction {
        ...
        let args = UpdateMetadataCollectionNftInstructionArgs {
...
/// `update_metadata_collection_nft` CPI accounts.
...
/// `update_metadata_collection_nft` CPI instruction.
pub struct UpdateMetadataCollectionNftCpi<'a, 'b> {
    ...
    pub __args: UpdateMetadataCollectionNftInstructionArgs,
}

impl<'a, 'b> UpdateMetadataCollectionNftCpi<'a, 'b> {
    pub fn new(
        program: &'b solana_program::account_info::AccountInfo<'a>,
        accounts: UpdateMetadataCollectionNftCpiAccounts<'a, 'b>,
        args: UpdateMetadataCollectionNftInstructionArgs,
    ) -> Self {
        Self {
            __program: program,
...
/// `update_metadata_collection_nft` CPI instruction builder.
pub struct UpdateMetadataCollectionNftCpiBuilder<'a, 'b> {
    instruction: Box<UpdateMetadataCollectionNftCpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> UpdateMetadataCollectionNftCpiBuilder<'a, 'b> {
    ...
    pub fn invoke_signed(
        ...
        let instruction = UpdateMetadataCollectionNftCpi {
