...
impl DelegateV2 {
    pub fn instruction(
        &self,
        args: DelegateV2InstructionArgs,
...
impl DelegateV2Builder {
    ...
    pub fn instruction(&self) -> solana_program::instruction::Instruction {
        ...
        let args = DelegateV2InstructionArgs {
...
/// `delegate_v2` CPI accounts.
pub struct DelegateV2CpiAccounts<'a, 'b> {
...
/// `delegate_v2` CPI instruction.
pub struct DelegateV2Cpi<'a, 'b> {
    ...
    pub __args: DelegateV2InstructionArgs,
}

impl<'a, 'b> DelegateV2Cpi<'a, 'b> {
    pub fn new(
        program: &'b solana_program::account_info::AccountInfo<'a>,
        accounts: DelegateV2CpiAccounts<'a, 'b>,
        args: DelegateV2InstructionArgs,
    ) -> Self {
        Self {
            __program: program,
...
impl<'a, 'b> DelegateV2CpiBuilder<'a, 'b> {
    pub fn new(program: &'b solana_program::account_info::AccountInfo<'a>) -> Self {
        let instruction = Box::new(DelegateV2CpiBuilderInstruction {
            __program: program,
            tree_config: None,
            payer: None,
            leaf_owner: None,
...
struct DelegateV2CpiBuilderInstruction<'a, 'b> {
