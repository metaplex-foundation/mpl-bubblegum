...
impl UnverifyCreatorV2 {
    pub fn instruction(
        &self,
        args: UnverifyCreatorV2InstructionArgs,
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let mut data = borsh::to_vec(&(UnverifyCreatorV2InstructionData::new())).unwrap();
...
pub struct UnverifyCreatorV2InstructionData {
    discriminator: [u8; 8],
}

impl UnverifyCreatorV2InstructionData {
    pub fn new() -> Self {
        Self {
...
pub struct UnverifyCreatorV2InstructionArgs {
    pub root: [u8; 32],
...
impl UnverifyCreatorV2Builder {
    ...
    pub fn instruction(&self) -> solana_program::instruction::Instruction {
        let accounts = UnverifyCreatorV2 {
        ...
        let args = UnverifyCreatorV2InstructionArgs {
...
/// `unverify_creator_v2` CPI accounts.
pub struct UnverifyCreatorV2CpiAccounts<'a, 'b> {
...
/// `unverify_creator_v2` CPI instruction.
pub struct UnverifyCreatorV2Cpi<'a, 'b> {
    ...
    pub __args: UnverifyCreatorV2InstructionArgs,
}

impl<'a, 'b> UnverifyCreatorV2Cpi<'a, 'b> {
    pub fn new(
        program: &'b solana_program::account_info::AccountInfo<'a>,
        accounts: UnverifyCreatorV2CpiAccounts<'a, 'b>,
        args: UnverifyCreatorV2InstructionArgs,
    ) -> Self {
        Self {
            __program: program,
...
impl<'a, 'b> UnverifyCreatorV2CpiBuilder<'a, 'b> {
    pub fn new(program: &'b solana_program::account_info::AccountInfo<'a>) -> Self {
        let instruction = Box::new(UnverifyCreatorV2CpiBuilderInstruction {
            __program: program,
            tree_config: None,
            payer: None,
            creator: None,
    ...
    pub fn invoke_signed(
        ...
        let instruction = UnverifyCreatorV2Cpi {
...
struct UnverifyCreatorV2CpiBuilderInstruction<'a, 'b> {
