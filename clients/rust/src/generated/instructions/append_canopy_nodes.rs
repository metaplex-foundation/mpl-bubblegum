...
impl AppendCanopyNodes {
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let mut data = AppendCanopyNodesInstructionData::new()
            .try_to_vec()
            .unwrap();
...
impl AppendCanopyNodesInstructionData {
    fn new() -> Self {
        Self {
...
pub struct AppendCanopyNodesInstructionArgs {
    pub start_index: u32,
...
/// Instruction builder.
#[derive(Default)]
pub struct AppendCanopyNodesBuilder {
...
/// `append_canopy_nodes` CPI accounts.
pub struct AppendCanopyNodesCpiAccounts<'a, 'b> {
...
/// `append_canopy_nodes` CPI instruction.
pub struct AppendCanopyNodesCpi<'a, 'b> {
    ...
    pub __args: AppendCanopyNodesInstructionArgs,
}

impl<'a, 'b> AppendCanopyNodesCpi<'a, 'b> {
    pub fn new(
        program: &'b solana_program::account_info::AccountInfo<'a>,
        accounts: AppendCanopyNodesCpiAccounts<'a, 'b>,
        args: AppendCanopyNodesInstructionArgs,
    ) -> Self {
        Self {
            __program: program,
...
/// `append_canopy_nodes` CPI instruction builder.
pub struct AppendCanopyNodesCpiBuilder<'a, 'b> {
    instruction: Box<AppendCanopyNodesCpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> AppendCanopyNodesCpiBuilder<'a, 'b> {
    pub fn new(program: &'b solana_program::account_info::AccountInfo<'a>) -> Self {
        let instruction = Box::new(AppendCanopyNodesCpiBuilderInstruction {
            __program: program,
            merkle_tree: None,
            authority: None,
            noop: None,
    ...
    pub fn invoke_signed(
        ...
        let instruction = AppendCanopyNodesCpi {
...
struct AppendCanopyNodesCpiBuilderInstruction<'a, 'b> {
